...
$lang = array_merge($lang, array(
	...
	'MERGE_INTERVAL_EXPLAIN'		=> 'Кількість годин, протягом якого повідомлення користувача будуть склеєні з його останнім повідомленням теми. Залиште поле порожнім або встановіть 0 для відключення цієї функції.',
	'MERGE_NO_TOPICS'				=> 'Теми без склеювання',
	'MERGE_NO_TOPICS_EXPLAIN'		=> 'Список розділених комами номерів тtм, в яких склеювання повідомлень вимкнено.',
