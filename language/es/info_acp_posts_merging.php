...
$lang = array_merge($lang, [
	...
	'MERGE_SEPARATOR_EXPLAIN'		=> 'Aquí puede configurar el separador que aparecerá entre las partes del mensaje fusionado.<br />Puede usar BBCodes que se analizará en función de la configuración del foro o del mensaje.<br /><br />También puede usar cualquier cadena de idioma presente en su directorio de language/ como esta: {L_<em>&lt;STRINGNAME&gt;</em>} dónde <em>&lt;STRINGNAME&gt;</em> es el nombre de la cadena traducida que desea agregar. Por ejemplo, {L_WROTE} se mostrará como “escribió” o su traducción de acuerdo con la configuración regional del usuario.<br /><br />Use <em>{TIME}</em> marcador de posición para incluir el tiempo transcurrido entre la fusión en el separador.',
]);
