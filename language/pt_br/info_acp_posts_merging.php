...
$lang = array_merge($lang, [
	...
	'MERGE_SEPARATOR_EXPLAIN'		=> 'Aqui você pode configurar o separador que será exibido entre os posts mesclados.<br />Você poderá usar BBCodes de acordo com as configurações do fórum ou configuração de mensagens.<br /><br />Você também pode usar qualquer string de idioma dos arquivos do pacote de idioma: {L_<em>&lt;STRINGNAME&gt;</em>} onde <em>&lt;STRINGNAME&gt;</em> é o nome da string traduzida que você quer adicionar. Por exemplo, {L_WROTE} será exibido como “escreveu”.<br /><br />Use o marcador <em>{TIME}</em> para incluir o horário entre o separador de posts mesclados.',
]);
