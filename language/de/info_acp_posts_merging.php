...
$lang = array_merge($lang, [
	...
	'MERGE_SEPARATOR_EXPLAIN'		=> 'Hier kannst Du das Trennzeichen konfigurieren, die zwischen den zusammengeführten Beiträge erscheinen.<br />Du kannst BBCodes in entsprechend den Board-Einstellungen oder Nachricht analysiert werden soll.<br /><br />Du kannst auch eine beliebige Sprachzeichenfolge vorhanden in Ihrer Sprache/ Verzeichnis wie folgt: {L_<em>&lt;STRINGNAME&gt;</em>} wo <em>&lt;STRINGNAME&gt;</em> ist der Name des übersetzten String den Du hinzufügen möchtest. Zum Beispiel, {L_WROTE} wird angezeigt als \'schrieb\' oder die Übersetzung nach Gebietsschema des Benutzers.<br /><br />Verwende <em>{TIME}</em> Platzhalter, um die Zeit zwischen Zusammenführen im Separator zu übergeben.',
]);
